...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        scores /= scores.sum(1)[:,np.newaxis]
        ...
        grads['W2'] = H1.T.dot(scores) / N + 2*reg*W2
        grads['b2'] = scores.sum(0) / N
        
        grad_hidden = scores.dot(W2.T) 
        grad_hidden[H1 == 0] = 0
        
        grads['W1'] = X.T.dot(grad_hidden) /N + 2*reg*W1
        grads['b1'] = grad_hidden.sum(0) /N
